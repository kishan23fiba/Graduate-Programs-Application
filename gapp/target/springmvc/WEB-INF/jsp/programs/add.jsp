	...
	<div class="col-md-6">			
		<div class="panel panel-default" >
			<div class="panel-body panel-primary">
				<div class="jumbotron">
					<h1><center>ADD-PROGRAMS</center></h1>
				</div>
				<center>
					<form:form modelAttribute="department">
						<div class="input-group">
  							<span class="input-group-addon" id="basic-addon3"><b>Program Name</b></span>
  							<input type="text" placeholder="Program Name" name="pname" class="form-control" id="basic-url" aria-describedby="basic-addon3" required="required">
						</div>
						<br />
