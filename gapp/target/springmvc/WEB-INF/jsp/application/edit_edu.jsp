...
<div class="container">
	...
	<div class="col-md-6">
		...
		<hr>
		<form action="edit_edu.html" method="post">
			<a href="../gapphomestudent/edit_add_edu.html?sid=${sid }" class="btn btn-primary">Add Educational Details</a><br /><br />
			<font color="white">
			<table class="table table-bordered">
				...
				<c:forEach items="${studentEdu}" var="e">
				<tr>
					<td>${e.collegeName }</td>
					<td>${e.degree }</td>
					<td>${e.timePeriod } years</td>
					<td>${e.major }</td>
					<td><a href="../gapphomestudent/edudelete.html?eid=${e.id}">Delete</a>
				</tr>
				</c:forEach>	
			</table>
			</font>
