...
<div class="container">
	...
	<a href="/springmvc/gapphomestudent/applicationlist.html?uid=${userid}" class="btn btn-primary">View Applications</a>
	<a href="/springmvc/gapphomestudent/add.html?uid=${userid}" class="btn btn-primary">Add Application</a>	
</div>
</body>
</html>